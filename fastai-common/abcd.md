...
```
<br>
* RandomForestRegressor — 회귀 분석기는 연속 변수를 예측하는 방법(예: 회귀 분석)입니다.<br>
* RandomForestClassifier — 분류자는 범주형 변수를 예측하는 방법입니다. (예: 분류)<br>
```
m.fit(df_raw.drop('SalePrice', axis=1), df_raw.SalePrice)
```
<br>
Scikit-learn 의 모든 것은 같은 형태를 가지고 있습니다.<br><br>
* 머신러닝 모델의 객체 인스턴스 생성 <br>
* fit함수에 독립 변수(예측할 변수)와 종속 변수(예측할 변수)를 전달하며 콜한다.<br>
* axis=1 은 열을 제거하는 것을 의미합니다.<br>
* shift + tab은 Jupyter 노트북에서 함수의 파라미터 검사를 불러옵니다.<br>
